...
//     try {
//       await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/create-rental`, data);
...
//             <Input type="number" {...register("pricing.dailyRate", { valueAsNumber: true })} />
//           </div>
//           <div>
//             <Label>Hourly Rate</Label>
//             <Input type="number" {...register("pricing.hourlyRate", { valueAsNumber: true })} />
//           </div>
//         </div>
...
//         {/* Submit Button */}
//         <Button type="submit" className="w-full">Submit Rental</Button>
//       </form>
//     </div>
// </>
// };
