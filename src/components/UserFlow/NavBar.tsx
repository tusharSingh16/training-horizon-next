      ...
      <div className="container mx-auto p-5">
        ...
        <div className="hidden md:flex justify-between items-center">
          <div className="flex space-x-4">
            ...
            <Link href="/trainers" className="text-gray-700 hover:text-black px-3 py-2 rounded-md text-sm font-medium">
              Our Trainers
            </Link>
          </div>
        ...
        <div className={`${isOpen ? "block" : "hidden"} md:hidden`}>
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <Link href="/trainers" className="text-gray-700 hover:text-black block px-3 py-2 rounded-md text-base font-medium">
              Our Trainers
            </Link>
            {loggedIn && (
              <>
                <Link href="/userflow/addListing" className="text-gray-700 hover:text-black block px-3 py-2 rounded-md text-base font-medium">
                  Add Listing
                </Link>
                <Link href="/userflow/registerMember" className="text-gray-700 hover:text-black block px-3 py-2 rounded-md text-base font-medium">
                  Register Member
                </Link>
              </>
            )}
