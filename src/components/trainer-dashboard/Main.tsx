...
const Main = () => {
  ...
  console.log(role);
  return (
    <div className="flex justify-center h-screen w-full py-5">
      <div className="flex-col w-4/5 ">
        ...
        <div className="flex  w-full  rounded-sm bg-white ring-1 ring-gray-300 z-10 py-10 px-10 gap-4 shadow-3xl">
